...
section in the :ref:`MarkupSpecs` for syntax
details.

.. comment: above :ref: added
...
directives.  For details on the hierarchy of elements, please see :ref:`docTree` and the `Docutils Generic DTD`_ XML document
type definition.  For directive implementation details, see `Creating
reStructuredText Directives`_.

.. comment: above :ref: added by TEN3

.. _Directives: restructuredtext.html#directives
.. comment: out by TEN3, reference adjusted .. _reStructuredText Markup Specification: restructuredtext.html
.. comment: out by TEN3, reference adjusted .. _The Docutils Document Tree: ../doctree.html
...
The author-supplied title is also used as a :ref:`classes2` attribute value
...
``class`` : text
    Overrides the computed :ref:`classes2` attribute value.

``name`` : text
  Add `text` to the :ref:`names` attribute of the admonition element.
...
Inline images can be defined with an "image" directive in a :ref:`substitution-definitions`.
...
``width`` : :ref:`length-units` or :ref:`percentage-units` of the current line width
...
.. comment: out by TEN3, reference adjusted    .. _length: restructuredtext.html#length-units
.. comment: out by TEN3, reference adjusted    .. _percentage: restructuredtext.html#percentage-units
...
``target`` : text (URI or reference name)
    ...
    :ref:`reference-names` with underscore suffix (e.g. ```a name`_``).

and the common options `:class:`_ and `:name:`_.

.. comment: out by TEN3, reference adjusted  .. _substitution definition: restructuredtext.html#substitution-definitions
...
``figwidth`` : "image", :ref:`length-units`, or :ref:`percentage-units` of current line width
...
``figclass`` : text
    Set a :ref:`classes2` attribute value on the figure element.  See the
...
.. admonition:: Deprecated
   ...
   The "line-block" directive is deprecated.  Use the :ref:`line block syntax <line-blocks>` instead.

.. comment: out by TEN3, reference adjusted   .. _line block syntax: restructuredtext.html#line-blocks
...
:Directive Type: "code"
:Doctree Element: literal_block_, :ref:`inline`
...
tokens are stored in nested :ref:`inline` with class arguments
...
``class`` : text
    Set a :ref:`classes2` attribute value on the topic element.  See the
    class_ directive below.
...
The :ref:`image` directive may be used both in substitution definitions
...
:Doctree Element: Text & :ref:`inline`
:Directive Arguments: None.
:Directive Options: None.
...
The "class" directive sets the :ref:`classes2` attribute value on its content
...
"inline" element with a :ref:`classes2` attribute, as in the first example
above.
...
``class`` : text
    Set the :ref:`classes2` attribute value on the element produced
...
_`:class:` : text
    Set a :ref:`classes2` attribute value on the doctree element generated by
    the directive. See also the class_ directive.

_`:name:` : text
    Add `text` to the :ref:`names` attribute of the doctree element generated
    by the directive. This allows :ref:`hyperlink references <hyperlink-targets>` to the element
    using `text` as :ref:`reference-names`.
    ...
    is a concise syntax alternative to preceding it with a :ref:`hyperlink-targets` ::
...
.. comment: TEN3 .. _reference name: restructuredtext.html#reference-names
.. comment: TEN3 .. _hyperlink target: restructuredtext.html#hyperlink-targets
.. comment: TEN3 .. _hyperlink references: restructuredtext.html#hyperlink-references
.. comment: TEN3 .. _"classes": ../doctree.html#classes
.. comment: TEN3 .. _"names": ../doctree.html#names
...
.. comment: TEN3 .. _image: ../doctree.html#image
.. comment: TEN3 (used _inline in docTree).. _inline elements: ../doctree.html#inline-elements
